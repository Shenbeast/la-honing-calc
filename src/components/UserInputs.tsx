  ...
  return (
    <UserInputWrapper>
      ...
      <div className="selectWrapper">
        ...
        >
          <option value={"4"}>{determineTierName("4")}</option>
        </select>
      </div>
      <div className="selectWrapper">
      ...
      <div className="selectWrapper">
        ...
        <select
          ...
          onChange={(e) => {
            const newUserGearInputs = { ...userInputs };
            newUserGearInputs.user_gear_inputs.desired_level = parseInt(
              e.target.value
            );
            setUserInputs(newUserGearInputs);
          }}
      ...
      <div className="selectWrapper">
        ...
        <input
          ...
          className="goldCrystalRate"
          type="number"
          value={userInputs.user_gear_inputs.crystal_rate}
          onChange={(e) => {
            const newUserGearInputs = { ...userInputs };
            newUserGearInputs.user_gear_inputs.crystal_rate = parseInt(
              e.target.value
            );
            setUserInputs(newUserGearInputs);
          }}
